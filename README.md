...
MAY 2023 NOTE: The Calico network plugin has been changing a lot lately. I recommend following the instructions at https://docs.tigera.io/calico/latest/getting-started/kubernetes/quickstart to install the Calico network plugin. 
